---
description: First-time workspace setup — installs Node deps, walks you through the Gemini API key, and helps connect the Meta Ads MCP connector. Run this once on day one.
---
